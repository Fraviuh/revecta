  ...
  return (
    <div style={{ width: "100%", maxWidth: "980px", display: "flex", flexDirection: "column", gap: "1rem", color: "#fff", textAlign: "left" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
        {/* B2C */}
        <Card accent={BLUE} style={{ padding: "1.1rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
        ...
        {/* B2B */}
        <Card accent={TEAL} style={{ padding: "1.1rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
  ...
  return (
    <div style={{ width: "100%", maxWidth: "1000px", display: "flex", flexDirection: "column", alignItems: "center", gap: "2rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1rem", width: "100%" }}>
        {asks.map((a) => (
          <Card key={a.title} accent={a.color} style={{ padding: "1.1rem", position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", gap: "2.5rem" }}>
