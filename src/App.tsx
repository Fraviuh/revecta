  ...
  return (
    <div style={{ width: "100%", maxWidth: "920px", display: "flex", flexDirection: "column", gap: "2rem", color: "#ffffff" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem", alignItems: "stretch" }}>
        <Card accent={BLUE} style={{ padding: "1.4rem 1.5rem", display: "flex", flexDirection: "column", gap: "4rem", height: "100%" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem", height: "100%" }}>
          <Card accent={TEAL} style={{ padding: "1.2rem 1.25rem", display: "flex", flexDirection: "column", gap: "0.75rem", flex: 1 }}>
