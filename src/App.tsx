...
function S2() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: "960px", display: "flex", flexDirection: "column", gap: "2.5rem", color: "#ffffff" }}>
...
function S5() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: "920px", display: "flex", flexDirection: "column", gap: "2.5rem" }}>
      <div style={{ textAlign: "center" }}>
...
function S7() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: "960px", display: "flex", flexDirection: "column", gap: "2.5rem" }}>
      <div style={{ textAlign: "center" }}>
